...
function init_daterangepicker_single_call() {
    ...
    $('#id_licenseexpiry').daterangepicker({
        singleDatePicker: true,
        singleClasses: "picker_3",
        gotoCurrent: true,
        locale: {
    ...
    $('#id_service_date').daterangepicker({
        singleDatePicker: true,
        singleClasses: "picker_3",
        gotoCurrent: true,
        locale: {
    ...
    $('#id_next_service').daterangepicker({
        singleDatePicker: true,
        singleClasses: "picker_3",
        gotoCurrent: true,
        locale: {
