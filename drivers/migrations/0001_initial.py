...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='identity_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='drivers.IdentityTypes'),
        ),
        migrations.AddField(
            model_name='driver',
            name='identity',
            field=models.ManyToManyField(to='drivers.IdentityScans'),
        ),
        migrations.AddField(
            model_name='driver',
            name='license_types',
            field=models.ManyToManyField(to='drivers.RacingLicenseTypes'),
        ),
        migrations.AddField(
            model_name='driver',
            name='licenses',
            field=models.ManyToManyField(to='drivers.RacingLicenseScans'),
        ),
        migrations.AddField(
            model_name='driver',
            name='profile_images',
            field=models.ManyToManyField(to='drivers.DriverProfile'),
        ),
        migrations.AddField(
            model_name='driver',
            name='username',
